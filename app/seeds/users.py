...
def seed_users():
    ...
    gary = User(
        ...
        city='San Diego',
        state='CA',
        avatar='https://i.imgur.com/wf9UEsq.jpg',
        bio="Sole Developer of La-Té. I'm currently looking for work as a software engineer!",
        cover_img='https://i.imgur.com/Jpgnkv1.jpg',
